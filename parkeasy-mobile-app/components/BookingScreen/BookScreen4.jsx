...
const BookScreen4 = ({ navigation }) => {
  ...
  const handleSubmit = () => {
    navigation.navigate("BookScreen5");
  };
        ...
        >
          ...
          >
            <View style={styles.vehicleInfo}>
              ...
              />
              <View>
                <Text style={styles.vehicleName}>Honda Civic</Text>
                <Text style={styles.vehicleNumber}>TN 00 AA 0000</Text>
              </View>
            </View>
            <Ionicons
              name={
          ...
          >
            <View style={styles.vehicleInfo}>
              ...
              />
              <View>
                <Text style={styles.vehicleName}>OLA</Text>
                <Text style={styles.vehicleNumber}>TN 00 AA 0000</Text>
              </View>
            </View>
            <Ionicons
